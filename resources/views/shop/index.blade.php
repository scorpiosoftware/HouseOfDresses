...
@section('content')
    <div class="mt-14 text-center">
        <h1 class="underline-offset-8 underline text-[#b69357] md:text-2xl text-xl">YOU ARE A GEM - COLLECTION</h1>
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <span class="ms-1 text-sm font-medium text-[#b69357] md:ms-2 dark:text-gray-400">You Are A Gem -
                            Collection</span>
                    </div>
                </li>
            </ol>

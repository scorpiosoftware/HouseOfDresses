<x-app-layout>
    ...
    @endif
    <div class="text-2xl py-4 font-bold underline  text-[#b69357] dark:text-white">Categories</div>
    <div class="relative m-4 md:flex justify-between items-center">
        ...
        <form action="{{ route('category.index', 'search') }}" class="w-full max-w-md " method="GET">
            @csrf
            @method('GET')

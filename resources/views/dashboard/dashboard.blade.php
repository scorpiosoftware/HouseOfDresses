                ...
                <tr class="bg-white border-b d:bg-gray-800 d:border-gray-700">
                    <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap d:text-white">
                        <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 38.51 38.5"
                            id="tiktok">
                            <defs>
                                <linearGradient id="a" x1="6.89" x2="31.62" y1="4.52"
                                    y2="33.98" gradientUnits="userSpaceOnUse">
                                    <stop offset="0" stop-color="#323232"></stop>
                                    <stop offset="1"></stop>
                                </linearGradient>
                                <linearGradient id="b" x1="6.87" x2="31.81" y1="4.1"
                                    y2="33.82" gradientUnits="userSpaceOnUse">
                            ...
                            <g style="isolation:isolate">
                                <g>
                                    <g>
                                        <g>
                                            <path fill="url(#a)"
                                                d="M38.51,19.25c0,.21,0,.42-.02.63-.15,5.04-2.29,9.62-5.64,12.97s-8.3,5.65-13.6,5.65c-.21,0-.42,0-.63-.02C8.33,38.15,0,29.63,0,19.25c0-5.29,2.17-10.11,5.66-13.6S13.96,0,19.25,0s10.11,2.16,13.6,5.65c3.49,3.49,5.66,8.31,5.66,13.6Z">
                                            </path>
                                            <g>
                                                <path fill="url(#b)"
                                                    d="M38.49,19.88c-.15,5.04-2.29,9.62-5.64,12.97s-8.3,5.65-13.6,5.65h-.61l-.02-.02c-2.64-2.64-5.23-5.23-7.9-7.89,1.34.9,2.95,1.42,4.69,1.42,4.66,0,8.43-3.77,8.43-8.42v-9.3c1.79,1.27,3.98,2.03,6.35,2.03v-3.59c.44.09.89.14,1.34.14,2.25,2.39,4.65,4.66,6.96,7.01Z">
                                                </path>
                                                <path fill="#ff1753"
                                                    d="M38.49,19.88c-.15,5.04-2.29,9.62-5.64,12.97s-8.3,5.65-13.6,5.65h-.61l-.02-.02c-2.64-2.64-5.23-5.23-7.9-7.89,1.34.9,2.95,1.42,4.69,1.42,4.66,0,8.43-3.77,8.43-8.42v-9.3c1.79,1.27,3.98,2.03,6.35,2.03v-3.59c.44.09.89.14,1.34.14,2.25,2.39,4.65,4.66,6.96,7.01Z"
                                            ...
                                            <g>
                                                <g>
                                                    <path fill="#ff1753" fill-rule="evenodd"
                                                    ...
                                                    <path fill="#00c9d0" fill-rule="evenodd"
                                                ...
                                                <path fill="#ff1753" fill-rule="evenodd"
                                                    d="M25.17,15.39c1.79,1.28,3.99,2.03,6.35,2.03v-4.56c-.45,0-.9-.05-1.33-.14v3.59c-2.37,0-4.56-.75-6.35-2.03v9.3c0,4.65-3.77,8.42-8.43,8.42-1.74,0-3.35-.52-4.69-1.42,1.53,1.56,3.66,2.53,6.03,2.53,4.66,0,8.43-3.77,8.43-8.42v-9.3h0Z"
                                                    opacity=".8"></path>
                                            </g>
                                        </g>
                                    </g>
            ...
            <div class="flex flex-wrap pb-3 mx-4 md:mx-24 lg:mx-0">
                ...
                <div class="w-full p-2 lg:w-1/4 md:w-1/2">
                    <div
                        ...
                        <div class="flex flex-row justify-between items-center">
                            <div class=" rounded-xl bg-opacity-30">
                                <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill-rule="evenodd" clip-rule="evenodd" image-rendering="optimizeQuality" shape-rendering="geometricPrecision" text-rendering="geometricPrecision" viewBox="0 0 512 512" id="tiktok">
                ...
                <div class="w-full p-2 lg:w-1/4 md:w-1/2">
                    <div
                        ...
                        <div class="flex flex-row justify-between items-center">
                            <div class=" rounded-xl bg-opacity-30">
                                <svg xmlns="http://www.w3.org/2000/svg" width='50' height='50' viewBox="0 0 512 512" id="google">

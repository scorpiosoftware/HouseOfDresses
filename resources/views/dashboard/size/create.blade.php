<x-app-layout>
    ...
    <div class="text-2xl py-4 font-bold underline text-gray-900 d:text-white">Create Size</div>
    <!-- Breadcrumb -->
    ...
    <form class="pt-4" action="{{ route('size.store') }}" enctype="multipart/form-data" method="POST">
        @csrf
        @method('POST')

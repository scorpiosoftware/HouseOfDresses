<x-app-layout>
    ...
    <div class="text-2xl py-4 font-bold underline text-gray-900 d:text-white">Edit Post</div>
    <!-- Breadcrumb -->
    ...
    <form class="pt-4" action="{{ route('post.update', $record->id) }}" enctype="multipart/form-data" method="POST">
        ...
        <div class="grid gap-6 mb-6 md:grid-cols-1">
            <div class="grid grid-cols-1 gap-4 border-2 p-4 md:grid-cols-2">
                <div>
                    <label for="post_url" class="block mb-2 text-sm font-medium text-gray-900 d:text-white">Post Url</label>

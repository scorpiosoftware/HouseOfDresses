<x-app-layout>
    ...
    {{-- End Breadcrumb  --}}
    <form class="pt-4"  action="{{ route('color.update', $record->id) }}" enctype="multipart/form-data"
        method="POST">
        @csrf
        @method('PUT')
        <div class="grid gap-6 mb-6 md:grid-cols-1">
            <div class="grid grid-cols-1 gap-4 border-2 p-4 md:grid-cols-2">
                ...
                <div>
                    <label for="color" class="block mb-2 text-sm font-medium text-gray-900 d:text-white">Hex Code</label>
                ...
                <div class="grid grid-cols-1 gap-4 border-2 p-4 md:grid-cols-2 md:col-start-1 md:col-end-3">
                    <div>
                        ...
                        <input type="text" id="width" value="{{ $record->width }}" name="width"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 d:bg-gray-700 d:border-gray-600 d:placeholder-gray-400 d:text-white d:focus:ring-blue-500 d:focus:border-blue-500"
                    ...
                    <div>
                        ...
                        <input type="text" id="height" value="{{ $record->height }}" name="height"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 d:bg-gray-700 d:border-gray-600 d:placeholder-gray-400 d:text-white d:focus:ring-blue-500 d:focus:border-blue-500"
                ...
                <div class="grid grid-cols-1 gap-4 border-2 p-4 md:grid-cols-2 md:col-start-1 md:col-end-3">
                    ...
                    <div id="gallery"
                        class="grid grid-cols-2 md:grid-cols-6 mx-auto gap-4 w-full md:col-start-1 md:col-end-3">
                        <input class="hidden" type="text" name="image" value="{{ $record->main_image_url }}">
                        <div class="relative">
                            <img class="max-w-full w-32 rounded-lg"

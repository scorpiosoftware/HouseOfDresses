<x-app-layout>
    ...
    @endif
    <div class="text-2xl py-4 font-bold underline text-gray-900 dark:text-white">Carousel</div>
    <!-- Breadcrumb -->
            ...
            <div class="grid grid-cols-1 gap-4 border-2 p-4 md:grid-cols-2">
                <div class="grid grid-cols-1 gap-4 border-2 p-4 md:grid-cols-2 md:col-start-1 md:col-end-3">
                    ...
                    <div class="w-full mt-2">
                        <div class="flex justify-between items-center">
                            <label for="images"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Carousel 
                                Images</label>
                        </div>
                        <div class="mt-4">

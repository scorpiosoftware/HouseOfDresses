    ...
    <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
        <ul class="space-y-2 font-medium">
            <li class="border-2 rounded-xl border-[#b69357]">
                <a href="{{ route('dashboard.index') }}"
                    class="flex items-center p-2 text-[#b69357] font-bold rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
            ...
            <li class="border-2 rounded-xl border-[#b69357]">
                <button type="button"
                    class="flex items-center w-full p-2 text-base text-[#b69357] font-bold transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                ...
                <ul id="dropdown-ecommerce" @if (Route::currentRouteName() == 'product.index' ||
                    ...
                    <li class="border-2 rounded-xl border-[#b69357]">
                        <a href="{{ route('brand.index') }}"
                            class="flex items-center w-full p-2 text-[#b69357] font-bold transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Brands</a>
                    </li>
                    <li class="border-2 rounded-xl border-[#b69357]">
                        <a href="{{ route('category.index') }}"
                            class="flex items-center w-full p-2 text-[#b69357] font-bold transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Categories</a>
                    </li>
                    <li class="border-2 rounded-xl border-[#b69357]">
                        <a href="{{ route('collection.index') }}"
                            class="flex items-center w-full p-2 text-[#b69357] font-bold transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Collections</a>
                    </li>
                    <li class="border-2 rounded-xl border-[#b69357]">
                        <a href="{{ route('size.index') }}"
                            class="flex items-center w-full p-2 text-[#b69357] font-bold transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Sizes</a>
                    </li>
                    <li class="border-2 rounded-xl border-[#b69357]">
                        <a href="{{ route('product.index') }}"
                            class="flex items-center w-full p-2 text-[#b69357] font-bold transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Products</a>
                    </li>
                    <li class="border-2 rounded-xl border-[#b69357]">
                        <a href="{{ route('color.index') }}"
                            class="flex items-center w-full p-2 text-[#b69357] font-bold transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Colors</a>
                    </li>

                    <li class="border-2 rounded-xl border-[#b69357]">
                        <a href="{{ route('order.index') }}"
                            class="flex items-center w-full p-2 text-[#b69357] font-bold transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Orders</a>
                    </li>
                </ul>
            </li>
            {{-- <li> --}}
                {{-- <button type="button"
                    ...
                    <span class="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap">Users - Roles</span>
                    <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
                        viewBox="0 0 10 6">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="m1 1 4 4 4-4" />

<div class="container px-12 md:px-24 mx-auto max-w-screen-xl">
   ...
   <div class="flex overflow-x-auto overflow-y-hidden scroll-smooth focus:scroll-auto justify-center content-center gap-5">
      ...
      <a class="wow fadeInUp shadow-sm" data-wow-delay="0.1s" href=""><img class="transition-all delay-75 hover:scale-[1.2]" src="{{ URL::to('storage/'.$brand->image_url) }}" width="350px" height="206px" alt=""></a>
      @endforeach
   </div>

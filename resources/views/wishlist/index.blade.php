...
@section('content')
    @if (session('wishlist'))
                                ...
                                <div
                                    ...
                                    <div class="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
                                        <a href="#" class="shrink-0 md:order-1">
                                            <img class="w-24 transition-all delay-0 hover:scale-125 dark:hidden"
        ...
        <div class="flex items-center justify-center mt-24 mb-10">
            <p class="text-4xl">No Items in the Wishlist  ! <a href="/shop" class="text-lg underline underline-offset-8 font-bold text-[#b69357]">continue shopping</a></p>
        </div>
    @endif
@endsection

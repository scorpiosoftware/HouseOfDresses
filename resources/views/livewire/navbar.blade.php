<div class="absolute top-20 md:px-20 px-2 z-40 w-full bg-transparent">
    <div class=" flex justify-between items-center">
        <div id="menu_btn" class="text-white font-bold flex justify-center items-center space-x-4 cursor-pointer">
            ...
            <span class="md:text-lg text-xs text-black">Menu</span>
        </div>

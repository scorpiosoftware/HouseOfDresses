<div id="cr_form"
    class="fixed hidden top-1/2 left-1/2 -translate-x-1/2 w-[750px]  px-4 py-6  -translate-y-1/2 -mt-1/2 -ml-1/2 z-50 bg-white">
    <div class="flex justify-end items-center">
        <button id="btn_signup" class="rounded-full px-3 text-xl font-bold">X</button>
    </div>
    <div class="container mx-auto  flex items-center space-x-5">
        <div class="basis-2/3">
            <img src="{{ URL::to('media/new/logo.png') }}" alt="">
        </div>

        <div class="px-20">
            <div class="text-center text-xl  text-black font-semibold">
                ...
                <div class="flex justify-center items-center space-x-1">
                    ...
                    <div class="mb-6">
                        <label for="password_confirmation"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Confirm</label>

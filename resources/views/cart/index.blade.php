                                ...
                                <div
                                    ...
                                    <div class="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
                                        <a href="#" class="shrink-0 md:order-1">
                                            <img class="h-32
                                             w-20 transition-all delay-0 hover:scale-125 dark:hidden"
                                        ...
                                        <div class="w-full min-w-0 flex-1 space-y-4 md:order-2 md:max-w-md">
                                            <a href="#"
                                                class="text-base font-medium text-gray-900 hover:underline dark:text-white">{{ $details['name'] }} - {{$details['color']}}</a>
                    ...
                    <div class="mx-auto mt-6 max-w-4xl flex-1 space-y-6 lg:mt-0 lg:w-full">
                        ...
                        <div
                            ...
                            <form class="space-y-4">
                                ...
                                <button type="submit"
                                    class="flex w-full items-center justify-center rounded-lg bg-[#b69357] px-5 py-2.5 text-sm font-medium text-white hover:bg-primary-800 focus:outline-none focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Apply
                                    Code</button>
                            </form>
                        </div>
                    </div>
